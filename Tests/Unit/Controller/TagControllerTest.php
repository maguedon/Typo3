...
/**
 * Test case for class Dawin\PgBlog\Controller\TagController.
 *
...
class TagControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin\PgBlog\Controller\TagController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin\\PgBlog\\Controller\\TagController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllTagsFromRepositoryAndAssignsThemToView()
	{
		...
		$tagRepository = $this->getMock('Dawin\\PgBlog\\Domain\\Repository\\TagRepository', array('findAll'), array(), '', FALSE);
