...
/**
 * Test case for class Dawin\PgBlog\Controller\PostController.
 *
...
class PostControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin\PgBlog\Controller\PostController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin\\PgBlog\\Controller\\PostController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPostsFromRepositoryAndAssignsThemToView()
	{
		...
		$postRepository = $this->getMock('Dawin\\PgBlog\\Domain\\Repository\\PostRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$post = new \Dawin\PgBlog\Domain\Model\Post();
